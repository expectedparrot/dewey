...
[Seltzer et al. (2023)](#ref-seltzer2023) provide an earlier LLM application of that respondent-specific logic. Market-research experts rated 69 percent of 300 generated SmartProbe follow-ups as good or very good. In parallel samples, 76 percent of responses elicited by SmartProbe received those ratings, compared with 25 percent under generic probing. The contrast supports tailoring follow-ups to the preceding answer, but it is not a clean treatment effect: the samples were not randomized, the systems were bundled, and the ratings were produced in-house. SmartProbe is therefore useful evidence about feasibility and design, not an independent validation benchmark.
...
The expanded evidence makes the design dependence clearer. [Xiao et al. (2020a)](#ref-xiao2020tell) found that a pre-LLM conversational survey elicited 39 percent more information and 25.7 percent higher aggregate response quality than a conventional open-ended survey. In a separate experiment, [Xiao et al. (2020b)](#ref-xiao2020hear) showed that adding comprehension and active-listening capabilities improved engagement, word count, user experience, and manually coded response quality relative to a baseline chatbot. [Jiang et al. (2023)](#ref-jiang2023) similarly found that a managed multi-agent design produced more specific, clear, and expansive responses with fewer conversational interruptions than a single-agent baseline. These studies locate value in particular interviewer functions rather than in conversational presentation alone.

But richer interaction is not automatic. [Cuevas et al. (2025)](#ref-cuevas2025) report high relevance and clarity across three chatbots while finding low cognitive empathy and palpability and little substantive advantage of the LLM conditions over a hard-coded baseline. [Chopra and Haaland (2023)](#ref-chopra2023), by contrast, document sustained engagement in roughly half-hour AI interviews and show how follow-ups reveal risk beliefs and misconceptions hidden beneath respondents' initial explanations. Together they sharpen the relevant distinction: adaptivity is valuable when it changes what the researcher learns, not merely how smoothly the exchange proceeds.
...
Two matched comparisons reinforce the caution about a single ranking. [Guven et al. (2025)](#ref-guven2025) randomly assigned forty participants to human or locally hosted AI text interviewers using the same interface and guide. Humans elicited longer answers per question, while the AI moved faster; coded specificity and relevance did not differ significantly. [Wuttke et al. (2024)](#ref-wuttke2024) likewise found broadly similar aggregate response quality and guideline adherence in a small political-interview study, but different errors: the AI missed follow-up opportunities and sometimes offered evaluative encouragement, whereas humans more often omitted active listening or suggested answers. Similar averages can therefore conceal different risks.
...
Even conventional chatbot comparisons resist a universal direction. [Kim et al. (2019)](#ref-kim2019) found less satisficing in a chatbot survey, but the advantage depended on conversational style. In a fourteen-day study, [Zarouali et al. (2024)](#ref-zarouali2024) found that web surveys often performed better on response characteristics, data quality, and user evaluation, while the chatbot performed better on attention checks. Duration, repetition, tone, and perceived security are therefore parts of the measurement technology rather than incidental interface details.
